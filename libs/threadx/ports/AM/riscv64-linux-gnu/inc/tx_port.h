...
#define TX_MINIMUM_STACK                        4096*6        /* Minimum stack size for this port  */
#endif
...
#define TX_TIMER_THREAD_STACK_SIZE              4096*6        /* Default timer thread stack size  */
#endif
...
#define TX_INT_ENABLE                           1  /* Enable interrupt value   */
...
#define TX_TRACE_TIME_SOURCE                    0xa0000048
#endif
...
CHAR                            _tx_version_id[] =
                                    "Copyright (c) Microsoft Corporation. All rights reserved. * ThreadX RISC-V64/GNU Version 6.3.0 *";
#else
